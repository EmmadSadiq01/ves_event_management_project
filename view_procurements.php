...
<?php
$emp = $conn->query("SELECT p.* FROM procurement p where p.id =".$_GET['id'])->fetch_array();
	foreach($emp as $k=>$v){
		$$k=$v;
	}
?>
...
<div class="contriner-fluid">
	<div class="col-md-12">
		<p><b>Procurement Bill ID : <?php echo $procurement_no ?></b></p>
		<p><b>Description: <?php echo ucwords($description) ?></b></p>
		<p><b>Amount: <?php echo ucwords($amount) ?></b></p>
		<p><b>Supplier Details: <?php echo ucwords($supplier_name) ?></b></p>
