...
$sql = "UPDATE bookingtarget SET target_date='$targetDate', target_price='$targetPrice', owner_id='$ownerId', hall_code='$hallCode', selectHall='$targetHall', selectShift='$targetshift' WHERE BTid='$targetID'";
