			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						<span><b>Procurement Bill No : <?php echo $pay['procurement_no'] ?></b></span>
					</div>
					<div class="card-body">
						...
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
									$images=$conn->query("SELECT * FROM procurement_img where recept_no=".$pay['id']) or die(mysqli_error());
									while($row=$images->fetch_array()){
								?>
								<tr>
									<td>
                                        <div class="show-image">
                                            <image id="myImg" src="assets/procurement_images/<?php echo $row["image_name"];?>" height="100" width="100"
