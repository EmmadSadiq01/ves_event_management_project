      ...
      <div class="modal-body">
        ...
        <div class="row" id="addPackagesBox">
          ...
          <div class="col-2 small-6 columns">
            <select name="add_package_name" class="form-control" placeholder="Package Name" id="select_pkg_1"
              onchange="getSelectPkgPrice(1)">
              <option value="">select</option>
            </select>
          </div>
          <div class="col-2 small-6 columns">
            <input type="text" name="add_package_price" class="form-control" placeholder="Package Price"
              id="select_pkg_price_1" onchange="calculateTotal(this.id.slice(15))">
          </div>
          <div class="col-2 small-6 columns">
            <input type="number" name="add_package_qty" class="form-control" placeholder="Qunantity"
              id="select_pkg_qty_1" onchange="calculateTotal(this.id.slice(15))">
            <input type="number" name="add_package_calculate" class="form-control" placeholder="Total"
              id="select_pkg_calculate_1" disabled>
          </div>

          <div class="col-2 small-6 columns">
            <textarea name="pkg_desc" id="pkg_desc_1" class="form-control" cols="30" rows="1"
              placeholder="Pakage Description"></textarea>
          </div>
...
<div class="modal fade" id="hallPackages" tabindex="-1" role="dialog" aria-labelledby="hallPackagesLabel"
aria-hidden="true">
...
<!--Return Packages-->
<div class="modal fade" id="returnPackages" tabindex="-1" role="dialog" aria-labelledby="returnPackagesLabel"
aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        <div class="small-12 medium-6 small-centered">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Username" name="return_pak_name"
              id="return_pak_name" aria-label="Username" aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Return Price</span>
            <input type="text" class="form-control" placeholder="Username" name="return_pak_price"
              id="return_pak_price" aria-label="Username" aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Qunantity</span>
            <input type="number" class="form-control" placeholder="Username" name="return_pak_qty"
              id="return_pak_qty" aria-label="Username" aria-describedby="basic-addon1" onchange="totalReturn()">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Total</span>
            <input type="number" class="form-control" placeholder="Username" name="return_pak_total"
              id="return_pak_total" aria-label="Username" aria-describedby="basic-addon1">
          </div>
