...
<?php
$pay = $conn->query("SELECT * FROM maintenance where id = " . $_GET['id'])->fetch_array();
?>
<!DOCTYPE html>
<html>
			...
			<div class="card">
				...
				<div class="card-body">
					<?php if ($_SESSION['login_type'] == 2) : ?>
						<div class="row">
							<div class="col-md-12">
								<form method="post" enctype="multipart/form-data" action="maintenance_upload.php">
					...
					<table id="table" class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							$images = $conn->query("SELECT * FROM maintenanace_img where recept_no=" . $pay['id']) or die(mysqli_error());
							while ($row = $images->fetch_array()) {
							?>
								<tr>
									<td>
										<div class="show-image">
											<image id="myImg" src="assets/maintenance_images/<?php echo $row["image_name"]; ?>" height="100" width="100" style="cursor:pointer" onclick="onClick(this)" class="modal-hover-opacity">
										</div>
									</td>
